...
\nconst BackgroundPlayback = registerPlugin<{\n  start: () => Promise<{ started: boolean }>;\n  stop: () => Promise<{ stopped: boolean }>;\n}>('BackgroundPlayback');\n
...
\n  // Mantiene el proceso Android vivo mientras la app está reproduciendo.\n  // El servicio no descarga ni extrae audio de YouTube; solo mantiene activo el WebView.\n  useEffect(() => {\n    if (!ytReady) return;\n    if (playing) {\n      BackgroundPlayback.start().catch(() => {});\n    } else {\n      BackgroundPlayback.stop().catch(() => {});\n    }\n  }, [playing, ytReady]);\n
